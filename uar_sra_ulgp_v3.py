...
def sampled_global_quantiles(x, q_low=0.10, q_high=0.97, max_samples=500000, seed=111):
    ...
    if flat.numel() <= max_samples:
        ...
        # Keep generator device-agnostic for wider PyTorch compatibility.
        g = torch.Generator()
        g.manual_seed(seed)
...
class AnomalyCLIPScorer:
    ...
    def score_batch(self, images, cls_id=None, return_amaps=False):
        ...
        with torch.amp.autocast("cuda"):
            ...
            # Per-image abnormal probability for the selected class.
...
def run(args):
    ...
    for cat in cats:
        ...
        all_a0, all_feat, all_u, all_img, all_sp = [], [], [], [], []
        gt_list, all_mask = [], []
